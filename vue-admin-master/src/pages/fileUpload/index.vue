<script scoped src="https://cdn.jsdelivr.net/npm/es6-promise/dist/es6-promise.auto.min.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/vuex/dist/vuex.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/vue-router/dist/vue-router.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/vue-i18n/dist/vue-i18n.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/marked/lib/marked.js"></script>
<script scoped src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release/build/highlight.min.js"></script>
<script scoped src="https://cdn.jsdelivr.net/gh/xkeshi/image-compressor/dist/image-compressor.js"></script>
<script scoped src="https://cdn.jsdelivr.net/npm/cropperjs/dist/cropper.js"></script>
...
<template>
  <div class="example-full">
    ...
    <h1 id="example-title" class="example-title">文件上传</h1>
          ...
          <tr v-if="!files.length">
            <td colspan="7">
              <div class="text-center p-5">
                ...
                <label :for="name" class="btn btn-lg btn-primary">点击上传</label>
              </div>
            </td>
          </tr>
